...
var CompanyController = require('./controller/AdminController');
app.use('/api/admin', CompanyController);

var CandidateController = require('./controller/ConsumerController');
app.use('/api/consumer', CandidateController);
